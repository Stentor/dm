...
<?php unset($this->config['list']['object_actions']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['list']['actions']) ? $this->config['list']['actions'] : array('_new' => array('label' => 'Add', 'title' => 'Add a %1%'), '_export' => array('label'=>'Export to CSV', 'title' => 'Export to CSV', 'params' => array('class' => 's16 s16_download')))) ?>;
