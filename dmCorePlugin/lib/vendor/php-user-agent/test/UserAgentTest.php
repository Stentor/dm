...
$userAgentString = 'Googlebot/2.1';
$userAgent = new phpUserAgent($userAgentString);
$t->is($userAgent->isBot(), true, 'User agent recognizes "googlebot" as a bot');

$t->is($userAgent->getBrowserVersion(), '2.1', 'User agent recognizes bot version');
