...
class dmCoreLayoutHelper extends dmConfigurable
{
	...
	public function renderHtmlTag()
	{
		...
		{
			$htmlTag = sprintf('<!--[if lt IE 7]> <html class="no-js lt-ie9 lt-ie8 lt-ie7"> <![endif]-->
<!--[if IE 7]> <html class="no-js lt-ie9 lt-ie8"> <![endif]-->
<!--[if IE 8]> <html class="no-js lt-ie9"> <![endif]-->
<!--[if gt IE 8]><!--> <html class="no-js" lang="%s" %s> <!--<![endif]-->', $culture, $this->getXmlNsDeclarations());
		}
		else
		{
			$htmlTag = sprintf(
        '<html class="no-js" xmlns="http://www.w3.org/1999/xhtml" xml:lang="%s"%s %s >',
			$culture,
  ...
  public function renderLiveReload() {
    if (dmConfig::get('enable_livereload')==1)
    {
      $url = dmConfig::get('livereload_url');
      return sprintf("<script src=\"$url\"></script>");
    }
  }
