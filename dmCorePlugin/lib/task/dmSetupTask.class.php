...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    if(!file_exists(dmOs::join(sfConfig::get('sf_web_dir'),'theme','config.rb')))
	$this->runTask('compass:create',array('theme'=>'theme','template'=>'dmDefault'));
    ...
    $this->dispatcher->notify(new sfEvent($this, 'dm.setup.after', array('clear-db' => $options['clear-db'], 'env' => $options['env'])));
