...
class dmDataLoad
{
  ...
  protected function loadSettings()
  {
    $array = array(
      ...
      'ga_demographics' => array(
        'description' => 'Enable Demographic tracking in GA code',
        'type' => 'boolean',
        'group_name' => 'tracking',
        'credentials' => 'google_analytics'
      ),
      ...
      //colorbox settings
      'colorbox_use_theme' => array(
          'type' => 'boolean',
          'default_value' => 1,
          'description' => 'Use a predefined colorbox theme',
          'group_name' => 'Colorbox',
      ),
      'colorbox_theme' => array(
        'type' => 'select',
        'default_value' => 'theme1',
        'params' => 'theme1=Theme 1 theme2=Theme 2 theme3=Theme 3 theme4=Theme 4 theme5=Theme 5',
        'group_name' => 'Colorbox',
      ),
      'enable_livereload' => array(
        'type' => 'boolean',
        'default_value' => 1,
        'description' => 'Use livereload while developping.',
        'group_name' => 'Dev Tools'
      ),
      'livereload_url' => array(
        'type' => 'text',
        'default_value' => '//localhost:35729/livereload.js',
        'description' => 'Url to livereload script',
        'group_name' => 'Dev Tools'
      ),
      'map_icon' => array(
        'type' => 'text',
  ...
  protected function loadLayouts()
  {
    ...
    {
      dmDb::create('DmLayout', array('name' => 'Global', 'css_class' => 'global'))->saveGet()->refresh(true);
    }
  }
  ...
  protected function loadPermissions()
  {
    $array = array(
      ...
      'behavior_add' => 'Add behaviors to page elements',
      'behavior_edit' => 'Edit settings of the behaviors',
      'behavior_delete' => 'Delete attached behaviors',
      'behavior_sort' => 'Sort the sequence of the behaviors'
    );
