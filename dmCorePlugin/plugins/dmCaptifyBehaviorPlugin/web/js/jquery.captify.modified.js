...
jQuery.fn.extend({
	captify: function(uo) {
		var o = $.extend({
			...
			className: 'captify-bottom',                    // the name of the CSS class to apply to the caption box         
		...
		$(this).each(function() {
			...
			$(this).load(function() {
				...
				var captionLabelHTML = $(this).prop(o.source); //!captionLabelSrc.length ? $(this).attr('alt') : captionLabelSrc.html();				
				...
				var cHide = function() {
					if (!over_caption && !over_img){
						...
						caption.animate(props, o.speedOut, o.easing);
						if (o.animation == 'fade'){
							$(captionContent).animate({opacity: 0}, o.speedOver, o.easing);
						}
					}
				};
					...
					$(this).hover(
						function() {
							...
							if (!over_caption) {
								...
								caption.animate(props, o.speedOver, o.easing);
								if (o.animation == 'fade'){
									captionContent.animate({opacity: 1}, o.speedOver, o.easing);
								}
							}
						},
						function() {
