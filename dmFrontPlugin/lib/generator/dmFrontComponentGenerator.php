...
\$this->{$this->module->getKey()}Pager = \$this->getPager(\$query, \$request->getParameter(\$this->getParamName()));
\$this->{$this->module->getKey()}Pager->setOption('url_params', \$request->getGetParameters());
";
        break;
      case 'show':
